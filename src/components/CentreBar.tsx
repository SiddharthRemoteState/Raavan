function CentreBar(){
    ...
    <div className="w-1/4 bg-[#1C1C1C] h-full">
        ...
        <div className="w-full h-full pl-5 pr-5">
            {/* Personal name div */}
            <div className="pt-7.5 pr-12.5 pb-7.5 font-semibold text-white">
                Personal
            </div>

            <div className="h-full overflow-y-auto">
            {FolderInfo.map((arr,index)=>(
                    <div key={index} className="w-full h-24.5 bg-[#FFFFFF33]  mb-4 p-5">
                    <div className="text-white">{arr.title}</div>
                    <div className="flex">
