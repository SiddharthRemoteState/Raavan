        ...
        id="FAD">
            ...
            <div className="pt-8">
                ...
                <div className="flex items-center pb-4">
                    ...
                    <p className="text-white font-semibold text-4 underline">{note.date}</p>
                </div>
                ...
                <div className="flex items-center pt-4">
                    ...
                    <p className="text-white font-semibold text-4 underline">{note.foldername}</p>
                </div>
            </div>

            {/* Content Section */}
            <div className="pt-7.5 overflow-auto pb-27">
                <p className="text-[#FFFFFF] text-400">{note.content}</p>
            </div>
        </div>
    );
}
